...
ax6.set_yticks(np.arange(0, 1.1, step=0.1))
ax7.set_yticks(np.arange(0, 1.1, step=0.1))
ax8.set_yticks(np.arange(0, 1.1, step=0.1))
ax9.set_yticks(np.arange(0, 1.1, step=0.1))
...
ax2.set_xticks([])
ax3.set_xticks([])
ax1.set_yticks(np.arange(30, 100, step=10))
ax2.set_yticks(np.arange(30, 100, step=10))
ax3.set_yticks(np.arange(30, 100, step=10))
ax1.grid(visible=True)
ax2.grid(visible=True)
ax3.grid(visible=True)
plt.show()
